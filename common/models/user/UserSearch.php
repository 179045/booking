...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'company_id', 'space_id'], 'integer'],
    ...
    public function getSpaceLeist()
    {
        return ArrayHelper::map(
            Space::find()->where(['company_id' => User::findOne(\Yii::$app->user->getId())->company_id])->all(),
            'id',
            'name'
        );
    }
